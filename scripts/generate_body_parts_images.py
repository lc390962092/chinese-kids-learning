...
IMAGE_DIR = BASE_DIR / "assets" / "images" / "body_parts"
IMAGE_DIR.mkdir(parents=True, exist_ok=True)

STYLE_BASE = "realistic photograph, soft natural lighting, clean background, educational children's book style, no text, no watermark, no cartoon, no big eyes"
...
def main():
    ...
    print(f"Found {len(words)} body part terms. Checking image files...")
