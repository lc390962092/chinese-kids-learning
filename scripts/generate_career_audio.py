...
CONTENT_FILE = BASE_DIR / "content" / "dream_jobs_module.json"
OUTPUT_DIR = BASE_DIR / "assets" / "audio" / "career"
...
async def main():
    ...
    print(f"开始生成 {len(items)} 个职业梦想音频...\n")
    ...
    for item in items:
        ...
        # 中文句子
        await speak_and_save(summary, sentence_dir / f"{file}_sentence.mp3", voice=VOICE, rate="+0%")
